 ...
 *
 *				- Se agrego la implementacion del metodo 'getPersonaByEmail' y 'insertPersona'
 *
 *				- Se agrego la implementacion del metodo 'updatePersona'
 *
 *				- Se agrego la implementacion del metodo 'deletePersona'
 * 
 * NOTA (05/08/2016):      
...
public class TestPersonasDaoImpl {
	...
	public void deberiaEliminarPersona() {
		try {
			System.out.println();
			logger.info("Inicio test 'deberiaEliminarPersona'");
